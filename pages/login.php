...
<head>
    ...
    <!-- a <base> faz os endereços curtos (css/style.css, index.php)
         funcionarem mesmo quando o login aparece em um endereço
         interno, tipo /sistema_gestao/listar/produto -->
