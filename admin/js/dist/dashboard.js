 ...
 */
function calcularTotalItensVendidos(itens) {
    return itens.reduce((totalAcumulado, item) => {
 ...
 */
function contarVendasUnicas(itens) {
    const idsUnicos = itens.reduce((acumulados, item) => {
 ...
 */
function calcularFaturamentoPorTipo(itens) {
 ...
 */
function montarResumoDashboard(itens) {
    return {
 ...
 */
function alternarEstadoVazio(estaVazio) {
 ...
 */
function renderizarFaturamentoPorTipo(faturamentoPorTipo) {
